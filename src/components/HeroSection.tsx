        ...
        <div className="mb-12 flex justify-center">
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-6 py-3">
            <p className="text-white text-sm font-inter">
              🔍 Découvrez notre livre blanc : comment réfléchir mes process et les automatiser seul
            </p>
          </div>
        </div>

        {/* H1 - Arvo Regular */}
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-arvo font-normal text-white mb-8 leading-tight">
          Agence tech & IA dédiées aux entreprises de la construction
        </h1>

        {/* H2 - Arvo Regular */}
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-arvo font-normal text-white mb-6 leading-relaxed">
          Logiciels spécifiques, automatisations conçus et construits sur mesure
        </h2>

        {/* H3 - Inter */}
        <h3 className="text-xl md:text-2xl font-inter text-white/90 mb-12 font-light">
          Ecoute - Conseils - Plan daction - Exécution
        </h3>

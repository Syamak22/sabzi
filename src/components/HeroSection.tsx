    ...
    <section className="py-20 px-6 text-center">
      <div className="max-w-6xl mx-auto">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-arvo font-normal text-white mb-8 leading-tight">
          Agence tech dédiées aux charpentiers et menuisiers
        </h1>

        {/* H2 - Arvo Regular */}
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-arvo font-normal text-white mb-6 leading-relaxed">
          Logiciels spécifiques conçus et construits à la demande
        </h2>
        ...
        <div className="flex justify-center">
          <button className="relative overflow-hidden bg-white text-[#125514] px-8 py-4 rounded-full text-lg font-inter font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg group">
            <span className="relative z-10">Audit offert</span>

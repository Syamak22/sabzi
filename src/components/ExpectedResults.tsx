            ...
            {results.map((result, index) => (
              <div key={index} className="relative group">
                ...
                <div className="relative bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 transform hover:scale-105 min-h-[320px] flex flex-col items-center text-center">
                  ...
                  {/* Description courte */}
                  <p className="text-white/90 font-inter leading-relaxed text-sm flex-1 line-clamp-3 mb-4">
                ...
                {openCard === index && (
                  ...
                  >
                    <div
                      className="bg-white/20 backdrop-blur-lg border border-white/30 rounded-3xl p-16 max-w-6xl w-full mx-auto my-8 transform scale-100 transition-all duration-500 ease-out shadow-2xl relative max-h-[90vh] overflow-y-auto overflow-x-hidden custom-scrollbar"
                      style={{
                        animation:
                    ...
                    >
                      ...
                      <button
                        onClick={handleCloseCard}
                        className="absolute top-6 right-6 inline-flex items-center gap-2 px-4 py-2 bg-red-500/20 hover:bg-red-500/30 border border-red-400/30 rounded-lg text-white text-sm font-medium transition-all duration-200 hover:scale-105 cursor-pointer"
                      >
                        <svg
                          width="16"
                          height="16"
                      ...
                      <div className="flex flex-col items-center text-center">
                        {/* Titre */}
                        <h3 className="text-5xl font-inter font-bold text-white mb-8">
                          {result.title}
                        </h3>

                        {/* Description complète au-dessus du SVG */}
                        <p className="text-white/90 font-inter leading-relaxed text-xl max-w-4xl break-words hyphens-auto mb-6 whitespace-pre-line text-justify">
                          {result.fullDescription}
                        </p>

                        {/* Exemple concret en italique */}
                        <p className="text-white/80 font-inter leading-relaxed text-lg max-w-4xl break-words hyphens-auto mb-10 italic">
                          {result.example}
                        </p>
